...
import static fit.xiaozhang.blog.constant.OptTypeConst.*;
...
public class ArticleController {
    ...
    public Result<String> saveArticleImages(MultipartFile file) {
        return new Result<>(true, StatusConst.OK, "上传成功", ossFeignClient.uploadImage(file, FilePathEnum.ARTICLE.getPath()));
    }
